...
public class ScreenSlow
{
    ...
    public ScreenSlow(int screenHeight, int screenWidth)
    {
    ...
    {
    	bufImage = Bitmap.createBitmap(SCREEN_WIDTH, SCREEN_HEIGHT, Bitmap.Config.ARGB_8888);
    }
    ...
    public final void swap(Canvas canvas)
    {
    	bufImage.setPixels(pbuf, 0, SCREEN_WIDTH, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
    	
        canvas.drawBitmap(bufImage, 0, 0, null);
    }
